    ...
    for param in range(PARAMS):
        ...
        for rnd in range(ROUNDS):
            ...
            if PLOT_ROUND or WEB_ROUND:
                ...
                fig_round_name_pdf ='img/fig_exec-{:>03d}_param-{:>02d}_round-{:>02}.pdf'.format(counter,param,rnd)
                ...
                #plt.ylim((0.0,1.7))
                #plt.legend(loc='upper right')
                fig_round_name_pdf2 ='img/fig_filled-{:>03d}_param-{:>02d}_round-{:>02}.pdf'.format(counter,param,rnd)
                ...
                #plt.ylim((0.0,1.7))
                #plt.legend(loc='upper right')
                fig_round_name2 ='img/fig_end_exo-{:>03d}_param-{:>02d}_round-{:>02}.pdf'.format(counter,param,rnd)
